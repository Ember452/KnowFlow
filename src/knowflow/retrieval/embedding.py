...
class EmbeddingClient:
    ...
    封装 SentenceTransformer, 按 embedding_batch_size 分批推理, 避免显存爆.
    单测可构造时传入 fake model(实现 encode 方法)绕过真实模型加载.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            model: 已加载的模型实例(单测注入 fake 用), 传入时跳过 model_name 加载.
        """
